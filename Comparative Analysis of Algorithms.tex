...
the implementation adopts the double hashing method of Kirsch and Mitzenmacher \cite{b1}. All $k$ hash values are calculated all from two base hashes, MD5 and SHA-1, where $h_i(x) = (h_1(x) + i
